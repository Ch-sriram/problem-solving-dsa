...
**_NOTE: The code is in the form of GitHub Gists and therefore there is no code inside the repo._**
...
- Number of `$`'s signify the importance of the data-structure/algorithm in question. `$$` < `$$$` < `$$$$` < `$$$$$` < `$$$$$$` in terms of importance.
- In the commits, the one with the difficulty and a `+` sign are worth going through because those problems introduce a new concept/trick altogether. Example: We've the following commit: [Two Numbers with Odd Occurrences (Easy+)](https://github.com/Ch-sriram/problem-solving-dsa/commit/123f226d6549b5a8677d95af651ffe4fe50e8d71) &mdash; we can see that it has `Easy+`, which means that problem difficulty is easy, but it is tricky to understand, and also, there's a concept (or concept refresher) related to the particular problem.

### Bit Manipulation 0️⃣1️⃣

1. **[Find First Set Bit](https://practice.geeksforgeeks.org/problems/find-first-set-bit-1587115620/1/)**: [Solution in C++](https://gist.github.com/Ch-sriram/c5e0657012b21b1521b678dfa29befd1)
...
7. **Check if given 'N' is [Power of 2](https://practice.geeksforgeeks.org/problems/power-of-2/0)**: [Solution in C++ [logarithmic time]](https://gist.github.com/Ch-sriram/62c046a0affda6907f0a06c8856ec74d) & [Solution in C++ [constant time]](https://gist.github.com/Ch-sriram/fd9fac753bfdffb423fd4d158038431d)
...
9. **[Exceptionally Odd](https://practice.geeksforgeeks.org/problems/find-the-odd-occurence4820/1)** &mdash; Print the number which occurs odd number of times in an array where every other number occurs even number of times: [Solution in C++](https://gist.github.com/Ch-sriram/e7454b413d3110fc71628593b974391a)
10. **[Bit Difference](https://practice.geeksforgeeks.org/problems/bit-difference-1587115620/1/)** &mdash; Given two integers A & B, find the number of bits that need to be flipped in B to convert it to A: [Solution in C++ (v1)](https://gist.github.com/Ch-sriram/2ec6bd3a3b9df442ce53ae260304f73e) & [Solution in C++ (v2)](https://gist.github.com/Ch-sriram/77435395e8b183a28bd2b633243307e6)
...
12. **[Swap All Odd & Even Bits](https://practice.geeksforgeeks.org/problems/swap-all-odd-and-even-bits-1587115621/1/)**: [Solution in C++ (v1)](https://gist.github.com/Ch-sriram/db50671bc159a3724d8b8318a58ab226) & [Solution in C++ (v2)](https://gist.github.com/Ch-sriram/8d80fa1527322119c93faf3f06aabe4f)
13. **[Number is Sparse or Not](https://practice.geeksforgeeks.org/problems/number-is-sparse-or-not-1587115620/1/)** &mdash; Sparseness Property states that "Given Number Should NOT contain any consecutive Set Bits": [Solution in C++](https://gist.github.com/Ch-sriram/cb5e6b35ae6e82fe31daab2cbf662270)
14. **[Maximum AND Value](https://practice.geeksforgeeks.org/problems/maximum-and-value2637/1)** &mdash; find the Maximum AND Value generated by any pair of elements from the array of size N: [Solution in C++](https://gist.github.com/Ch-sriram/030d832d89a5d647309a2e36234be325) `$$`
...
19. **[Maximum XOR in Array](https://practice.geeksforgeeks.org/problems/maximum-subset-xor/1/)** &mdash; return an integer denoting the maximum XOR value in the given positive integer array: [Solution in C++](https://gist.github.com/Ch-sriram/5e897a97f4d4ac6e6571ab7a5d989707) `$$$$$`
20. **[Maximum XOR Subset](https://practice.geeksforgeeks.org/problems/maximum-xor-subset0715/1/)** &mdash; find the maximum XOR value of the elements from all the possible subsets of given positive integer array arr[]: [Solution in C++](https://gist.github.com/Ch-sriram/4695c33b627087bf05326128c7080eac) `$$$$$`
...
7. Painters Partition Problem (aka _Allotting Books to Students_ Problem) \[`Binary Search` - O(N\*log(Sum(A[0:N-1])))\]: [Solution in C++](https://gist.github.com/Ch-sriram/163cf6a98d07a5ea077cafe9bb12e6e5) & [Solution in Java](https://gist.github.com/Ch-sriram/3e49d229ada23d924163d16d3e3c8953) `$$$$$`
...
6. **[Detect Cycle in an Undirected Graph](https://practice.geeksforgeeks.org/problems/detect-cycle-in-an-undirected-graph/1/)**: [Solution in C++ Using DFS](https://gist.github.com/Ch-sriram/42d46bc987002d2e4cb13d8be1eedba7) `$$$$` (**[GYTWorkz Technologies](https://www.gytworkz.com/) Interview Question**)
...
9. **[3Sum Closest](https://leetcode.com/problems/3sum-closest/)** &mdash; Uses `two-pointer` technique: [Solution in C++](https://gist.github.com/Ch-sriram/b25b9e2ca718b306d45e322666154c27) `$$$` (**[GYTWorkz Technologies](https://www.gytworkz.com/) Interview Question**)
...
12. **[Area of Container with Most Amount of Water](https://i.ibb.co/hVT71cp/Container-with-most-water.png)** &mdash; `finding-smaller-elements-stack` `carry-forward-max` `trapping-rainwater + area-under-histogram` : [Solution in C++](https://gist.github.com/Ch-sriram/d3d730523c96bed2dbff1f8c6103d16c) `$$$$$$` (**[GYTWorkz Technologies](https://www.gytworkz.com/) Interview Question**)
