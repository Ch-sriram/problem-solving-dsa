...
### Bit Manipulation 0️⃣1️⃣
  ...
  7. **Check if given 'N' is [Power of 2](https://practice.geeksforgeeks.org/problems/power-of-2/0)**: [Solution in C++ [Time: O(logN); Space: O(1)]](https://gist.github.com/Ch-sriram/62c046a0affda6907f0a06c8856ec74d) & [Solution in C++ [Time: O(1); Space: O(1)]](https://gist.github.com/Ch-sriram/fd9fac753bfdffb423fd4d158038431d)
